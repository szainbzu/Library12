package edu.cs.birzeit.library12;

import androidx.appcompat.app.AppCompatActivity;
import edu.cs.birzeit.library12.model.Book;
import edu.cs.birzeit.library12.model.BookDa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                List<Book> result = bookDa.getBooksByType(type);
                String books = "";
                for(Book b:result){
                    books+=b.getTitle() + "\n";
                }
                txtResult.setText(books);
